...
<head>
  ...
  <title>Booth Twenty - <?php echo $judul;; ?></title>
              ...
              <div class="col-lg-12">
                ...
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-warning font-weight-bold mb-4">BOOTH TWENTY</h1>
                  </div>
                  ...
                  <form method="post" action="<?php echo site_url('user/login/'); ?>">
                    ...
                    <input type="submit" name="submit" value="Login" class="btn btn-warning btn-user btn-block">
