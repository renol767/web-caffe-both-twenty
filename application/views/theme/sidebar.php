<ul class="navbar-nav bg-white sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
    ...
    <div class="text-warning">Booth Twenty</div>
  </a>
  ...
  <li class="nav-item active">
    <a class="nav-link" href="<?php echo site_url('daftarmenu/read'); ?>">
      <i class="fas fa-fw fa-home text-warning"></i>
      <span class="text-warning">Daftar Menu</span>
    </a>
  </li>
  ...
  <li class="nav-item active">
    ...
    <!-- Nav Item - Charts -->
  <li class="nav-item active">
    <a class="nav-link" href="<?php echo site_url('pesanan/read'); ?>">
      <i class="fas fa-fw fa-users text-warning"></i>
      <span class="text-warning">Data Pesanan</span></a>
  </li>
